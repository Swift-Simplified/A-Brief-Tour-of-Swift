...
//: This Xcode playground was created by Apple  to introduce the Swift programming language. This tour is no longer in circulation but Apple do maintain an online html version. The online tour can be found on the [Swift.org](https://www.swift.org) website [here](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/guidedtour).
//:
